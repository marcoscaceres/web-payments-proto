...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__currencies_js__ = __webpack_require__(33);
...
class PaymentCurrencyAmount {
  constructor(currency, value) {
    if (!__WEBPACK_IMPORTED_MODULE_0__currencies_js__["a" /* currencies */].has(currency)) {
  ...
  toString() {
    const { symbol } = __WEBPACK_IMPORTED_MODULE_0__currencies_js__["a" /* currencies */].get(this.currency);
...
/* harmony export (immutable) */ __webpack_exports__["a"] = currencies;
...
var Commons = __webpack_require__(90)
var CustomEventTarget = __webpack_require__(314)
var EventWrapper = __webpack_require__(315)
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__DisplayItem__ = __webpack_require__(123);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Localizable__ = __webpack_require__(329);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__PaymentCurrencyAmount_js__ = __webpack_require__(29);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_hyperhtml_hyperhtml__ = __webpack_require__(18);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__currencies_js__ = __webpack_require__(33);
...
function toDefListItem(paymentItem) {
  ...
  const { name: currencyName, symbol: currencySymbol } = __WEBPACK_IMPORTED_MODULE_1__currencies_js__["a" /* currencies */].get(code);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_hyperhtml_hyperhtml_js__ = __webpack_require__(18);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__PaymentSheet_DataSheet__ = __webpack_require__(333);
...
class PaymentMethodChooser extends __WEBPACK_IMPORTED_MODULE_1__PaymentSheet_DataSheet__["a" /* default */] {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__PaymentRequest_js__ = __webpack_require__(331);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__InventoryTable__ = __webpack_require__(328);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__PaymentCurrencyAmount__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__PaymentShippingOption__ = __webpack_require__(92);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__OrderSummary__ = __webpack_require__(330);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ShippingOptions__ = __webpack_require__(339);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__TaxCalculator__ = __webpack_require__(340);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__InventorySummary__ = __webpack_require__(327);
...
var __WEBPACK_AMD_DEFINE_RESULT__;(function() {
  ...
  if ("function" === 'function' && 'amd' in __webpack_require__(326)) {
    // AMD support
...
var createUniqueKey = __webpack_require__(90).createUniqueKey
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(63), __webpack_require__(318)))
...
var bytesToUuid = __webpack_require__(323);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__LineItemRenderer__ = __webpack_require__(124);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__PaymentCurrencyAmount_js__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_event_target_shim__ = __webpack_require__(43);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_hyperhtml_hyperhtml__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_hyperhtml_hyperhtml___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_hyperhtml_hyperhtml__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__PaymentCurrencyAmount__ = __webpack_require__(29);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__currencies__ = __webpack_require__(33);
...
class OrderSummary {
  constructor(summaryElem, sections = [], defaultCurrency = "USD") {
    if (!__WEBPACK_IMPORTED_MODULE_4__currencies__["a" /* currencies */].has(defaultCurrency)) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_uuid_v4__ = __webpack_require__(325);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_event_target_shim__ = __webpack_require__(43);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__PaymentSheet_js__ = __webpack_require__(338);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__PaymentCurrencyAmount__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__PaymentSheet_PaymentMethodChooser__ = __webpack_require__(125);
...
const paymentSheet = new __WEBPACK_IMPORTED_MODULE_2__PaymentSheet_js__["a" /* default */]();
...
class PaymentRequest extends __WEBPACK_IMPORTED_MODULE_1_event_target_shim___default()(eventListeners) {
  ...
  async show() {
    ...
    const supported = Array
      ...
      .filter(__WEBPACK_IMPORTED_MODULE_4__PaymentSheet_PaymentMethodChooser__["a" /* default */].supports);
    if (!supported.length) {
...
function processShippingOptions({ shippingOptions }) {
  ...
  const areValid = shippingOptions.every(
    ({ amount: { value } }) => __WEBPACK_IMPORTED_MODULE_3__PaymentCurrencyAmount__["a" /* default */].isValid(value)
  );
  if (!areValid) {
...
class Controls extends __WEBPACK_IMPORTED_MODULE_1_event_target_shim___default()(["cancel", "continue"]) {
  constructor() {
    super();
    const priv = privates.set(this, new Map()).get(this);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_hyperhtml_hyperhtml__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_hyperhtml_hyperhtml___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_hyperhtml_hyperhtml__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__PaymentSheet_Controls__ = __webpack_require__(332);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_event_target_shim__ = __webpack_require__(43);
...
class DataSheet extends __WEBPACK_IMPORTED_MODULE_2_event_target_shim___default()(["abort"]) {
  constructor(heading, dataForm) {
    ...
    priv.set("renderer", __WEBPACK_IMPORTED_MODULE_0_hyperhtml_hyperhtml___default.a.bind(containerElem));
    const controlButtons = new __WEBPACK_IMPORTED_MODULE_1__PaymentSheet_Controls__["a" /* default */]();
  }
  render(data) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__currencies_js__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__PaymentCurrencyAmount__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_hyperhtml_hyperhtml_js__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_hyperhtml_hyperhtml_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_hyperhtml_hyperhtml_js__);
...
class LineItems {
  constructor() {
    ...
    containerElem.appendChild(table);
    priv.set("containerElem", containerElem);
    priv.set("renderer", __WEBPACK_IMPORTED_MODULE_2_hyperhtml_hyperhtml_js___default.a.bind(table));
  }
  ...
  render(requestData) {
    ...
    const renderer = privates.get(this).get("renderer");
    const { symbol } = __WEBPACK_IMPORTED_MODULE_0__currencies_js__["a" /* currencies */].get(currency);
    ...
    return renderer `${
      lineItemsHTML.length ? lineItemsHTML : __WEBPACK_IMPORTED_MODULE_2_hyperhtml_hyperhtml_js___default.a.wire()`<tr><td colspan="2">No line items</td></tr>`
    }`;
  }
...
function toTR(lineItem) {
  ...
  const { symbol } = __WEBPACK_IMPORTED_MODULE_0__currencies_js__["a" /* currencies */].get(currency);
  return __WEBPACK_IMPORTED_MODULE_2_hyperhtml_hyperhtml_js___default.a.wire(lineItem)
  `<tr>
...
class ShippingOptions extends __WEBPACK_IMPORTED_MODULE_2_event_target_shim___default()(["change"]) {
  constructor() {
    super();
    const priv = privates.set(this, new Map()).get(this);
...
function toOption(shippingOption) {
  ...
  const { symbol } = __WEBPACK_IMPORTED_MODULE_1__currencies_js__["a" /* currencies */].get(currency);
...
function toTR(lineItem) {
  const { label, dir, lang, amount } = lineItem;
  const { currency, value } = amount;
  const { symbol } = __WEBPACK_IMPORTED_MODULE_0__currencies_js__["a" /* currencies */].get(amount.currency);
  return __WEBPACK_IMPORTED_MODULE_2_hyperhtml_hyperhtml_js___default.a.wire(lineItem)
  `<tr>
      <td lang="${lang}" dir="${dir}">${label}</td>
      <td>${symbol}${value} ${currency}</td>
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_dialog_polyfill_dialog_polyfill__ = __webpack_require__(313);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_dialog_polyfill_dialog_polyfill___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_dialog_polyfill_dialog_polyfill__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_hyperhtml_hyperhtml_js__ = __webpack_require__(18);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_event_target_shim__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_event_target_shim___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_event_target_shim__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_dialog_polyfill_dialog_polyfill_css__ = __webpack_require__(322);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_dialog_polyfill_dialog_polyfill_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_dialog_polyfill_dialog_polyfill_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__css_payment_sheet_css__ = __webpack_require__(321);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__css_payment_sheet_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__css_payment_sheet_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__PaymentSheet_Host__ = __webpack_require__(334);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__PaymentSheet_Total__ = __webpack_require__(337);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__PaymentSheet_LineItems__ = __webpack_require__(335);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__PaymentSheet_PaymentMethodChooser__ = __webpack_require__(125);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__PaymentSheet_ShippingOptions__ = __webpack_require__(336);
...
class PaymentSheet extends __WEBPACK_IMPORTED_MODULE_2_event_target_shim___default()(eventListeners) {
  constructor() {
    super();
    const priv = privates.set(this, new Map()).get(this);
    ...
    priv.set("renderer", __WEBPACK_IMPORTED_MODULE_1_hyperhtml_hyperhtml_js___default.a.bind(dialog));
    ...
    priv.set("topWidgets", [
      ...
      new __WEBPACK_IMPORTED_MODULE_9__PaymentSheet_ShippingOptions__["a" /* default */](),
      new __WEBPACK_IMPORTED_MODULE_6__PaymentSheet_Total__["a" /* default */](),
    ]);
...
/* harmony export (immutable) */ __webpack_exports__["a"] = PaymentSheet;
...
function attatchDialog(dialog) {
  return new Promise((resolve) => {
    const attachAndDone = () => {
      ...
      __WEBPACK_IMPORTED_MODULE_0_dialog_polyfill_dialog_polyfill___default.a.registerDialog(dialog);
      return resolve();
    }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_event_target_shim__ = __webpack_require__(43);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_hyperhtml_hyperhtml_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_hyperhtml_hyperhtml_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__PaymentCurrencyAmount_js__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__PaymentShippingOption_js__ = __webpack_require__(92);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__currencies_js__ = __webpack_require__(33);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__PaymentCurrencyAmount__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__LineItemRenderer__ = __webpack_require__(124);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__PaymentItem__ = __webpack_require__(91);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__currencies__ = __webpack_require__(33);
...
class TaxCalculator extends __WEBPACK_IMPORTED_MODULE_1__LineItemRenderer__["a" /* default */] {
  constructor(taxPercent, sections = [], defaultCurrency = "USD") {
    super();
    if (!__WEBPACK_IMPORTED_MODULE_3__currencies__["a" /* currencies */].has(defaultCurrency)) {
      throw new TypeError(`Unknown currency ${defaultCurrency}`);
    }
    const priv = privates.set(this, new Map()).get(this);
